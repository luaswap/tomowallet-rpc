...
async function getPrice(token) {
  try {
    ...
    if (token === 'USDC' || token === 'USDCT' || token === '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48' || token == '0xdac17f958d2ee523a2206206994597c13d831ec7') {
      return 1
    }
  
    if (token === 'LUA' || token === '0xb1f66997a5760428d3a87d68b90bfe0ae64121cc') {
    ...
    else if (token === 'ETH' || token === '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2') {
    ...
    else if (token === 'SRM' || token === '0x476c5e26a75bd202a9683ffd34359c0cc15be0ff') {
    ...
    else if (token === 'FTT' || token === '0x50d1c9771902476076ecfc8b2a83ad6b9355a4c9') {
    ...
    else if (token === 'KAI' || token === '0xd9ec3ff1f8be459bb9369b4e79e9ebcf7141c093') {
    ...
    else if (token === 'OM' || token === '0x2baecdf43734f22fd5c152db08e3c27233f0c7d2') {
    ...
    else if (token === 'FRONT' || token === '0xf8c3527cc04340b208c854e985240c02f7b7793f') {
    ...
    console.error('get price error', ex.toString());
    return 0
  }
}
